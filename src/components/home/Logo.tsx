...
const Logo = () => {
  ...
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
    ...
    <div className="mt-5 max-w-3xl text-center mx-auto">
      <p className="text-lg text-primary2 dark:text-primary">Repcode.io is an open-source, completely free to use tool to help you learn programming at a pace that&apos;s tailored to you. Think Anki, but for coding.</p>
    </div>
