    ...
    <div className="mx-4 sm:mx-6 md:mx-8 lg:mx-16"> {/* Adjusts the margin for different screen sizes */}
      ...
      <div className="flex flex-col md:flex-row-reverse items-center justify-center py-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left md:pr-5">
          <h2 className="text-xl md:text-2xl font-bold text-neutral dark:text-white">Custom Coding-Friendly Interface</h2>
          <p className="text-primary2 dark:text-primary mt-4 md:mt-2">Practice your whiteboarding skills by solving problems in an integrated code editor that supports syntax highlighting for 5 different languages</p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center py-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left md:pl-5">
          <h2 className="text-xl md:text-2xl font-bold text-neutral dark:text-white">Scientifically Backed Spatial Repetition Algorithm</h2>
          <p className="text-primary2 dark:text-primary mt-4 md:mt-2">Every day, solve only the problems you need to so your brain learns new strategies and reinforces key concepts in the most effective way possible</p>
        </div>
      </div>
    </div>
  );
