    ...
    return (
      <div id="contact" className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="mt-12 max-w-lg mx-auto">
              <div className="flex flex-col bg-neutral border border-neutral rounded-xl shadow-sm p-4 sm:p-6 lg:p-8">
                  <form onSubmit={handleSubmit}>
                      <div className="grid gap-4 lg:gap-6">
                          ...
                          <div>
                              <label className="block text-sm mb-2 text-white">Details</label>
          ...
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 lg:gap-8">
              <Link className="group flex flex-col h-full text-center rounded-lg hover:bg-white/[.05] p-4 sm:p-6" href="/guide">
                  <svg className="size-9 text-white mx-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
                  <div className="mt-5">
                      <h3 className="text-lg font-semibold text-white">Guide</h3>
                      <p className="mt-1 text-white">If you are confused on where to start, try reading our extensive guide</p>
              ...
              <Link className="group flex flex-col h-full text-center rounded-lg hover:bg-white/[.05] p-4 sm:p-6" href="/changelog">
                  <svg className="size-9 text-white mx-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 9a2 2 0 0 1-2 2H6l-4 4V4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2v5Z"/><path d="M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1"/></svg>
                  <div className="mt-5">
                      <h3 className="text-lg font-semibold text-white">Updates</h3>
                      <p className="mt-1 text-white">Been a while? No worries, see what has been changed and what is new</p>
                      <p className="mt-5 inline-flex items-center gap-x-1 font-medium text-primary">
                          View updates
                          <svg className="flex-shrink-0 size-4 transition ease-in-out group-hover:translate-x-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                      </p>
              ...
              <Link className="group flex flex-col h-full text-center rounded-lg hover:bg-white/[.05] p-4 sm:p-6" href="/home/SignInUp">
                  <svg className="size-9 text-white mx-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m7 11 2-2-2-2"/><path d="M11 13h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>
                  <div className="mt-5">
                      <h3 className="text-lg font-semibold text-white">Get Started</h3>
                      <p className="mt-1 text-white">Jump right in and start creating collections and problems today!</p>
                      <p className="mt-5 inline-flex items-center gap-x-1 font-medium text-primary">
                          Log in
                          <svg className="flex-shrink-0 size-4 transition ease-in-out group-hover:translate-x-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6"/></svg>
                      </p>
