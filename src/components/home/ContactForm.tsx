    ...
    return (
      <div id="contact" className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div className="mt-12 max-w-lg mx-auto">
              <div className="flex flex-col bg-nav rounded-md shadow-lg p-4 sm:p-6 lg:p-8">
          ...
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 lg:gap-8">
              <Link className="group flex flex-col h-full text-center rounded-lg hover:bg-neutral/[.05] p-4 sm:p-6" href="/guide">
                  ...
                  <div className="mt-5">
                      <h3 className="text-lg font-semibold text-secondary">Guide</h3>
              ...
              <Link className="group flex flex-col h-full text-center rounded-lg hover:bg-neutral/[.05] p-4 sm:p-6" href="/changelog">
                  ...
                  <div className="mt-5">
                      <h3 className="text-lg font-semibold text-secondary">Updates</h3>
              ...
              <Link className="group flex flex-col h-full text-center rounded-lg hover:bg-neutral/[.05] p-4 sm:p-6" href="/login">
                  ...
                  <div className="mt-5">
                      <h3 className="text-lg font-semibold text-secondary">Get Started</h3>
