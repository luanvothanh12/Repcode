        ...
        <div className="flex flex-col min-h-screen bg-base_100">
            ...
            <main className="flex-grow flex flex-col items-center justify-center px-4 py-8 text-primary">
                ...
                <div className="max-w-4xl text-center space-y-6">
                    ...
                    <p className="text-lg">Refunds: We offer no-questions-asked refunds up to 14 days after the initial successful payment, for both the Monthly Pro Membership and Lifetime Membership purchases. For inquiries relating to refunds, please contact repcodebusiness@gmail.com.</p>
