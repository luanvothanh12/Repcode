    ...
    return (
        <div className="flex flex-col min-h-screen bg-white dark:bg-base_100">
            ...
            <div className="p-8 m-24">
                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-2 inline-block border-b-2 border-feintwhite dark:border-divide text-neutral dark:text-white">Introduction</h2>
                    <p className="text-primary2 dark:text-primary mb-8">Welcome to Repcode.io, a platform designed to empower software engineers to excel in their technical interviews. Whether you are starting your coding journey, preparing for your next job interview, or just looking to refine your problem-solving skills, Repcode.io is here to support you every step of the way. Repcode.io is not just another coding platform; it is a comprehensive ecosystem where users can create, manage, and practice coding problems. Explore our Study Mode, which employs a spatial-repetition algorithm inspired by Anki's Super Memo 2, to undergo a tailored learning experience that adapts to your progress and preferences.</p>

                </div>

                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-2 inline-block border-b-2 border-feintwhite dark:border-divide text-neutral dark:text-white">Why Repcode.io?</h2>
                    <p className="text-primary2 dark:text-primary mb-8">When I first started preparing for technical interviews, I did what pretty much every aspiring software engineer does: I created a Leetcode account and started doing problems, starting with Array problems marked as Easy. I quickly ran into the first major issue: how can I organize these problems? Where can I store them for quick lookup and retreival later? Leetcode does actually have a built-in My Lists page that lets users create and customize their own problem collections, but there are three major problems with it: first, it is unintuitive. It is tricky to figure out how to add your own custom solutions to problems, and you can't customize the problem at all either. Second: you can only add problems from Leetcode to these lists. So if it a problem from any other source you are out of luck. Third: The My Lists page simply offers a way to organize problems, but what about a strategy for practicing them? When you only have 10 or 20 so problems that you are familiar with, the problem solving strategy is simple: just do those problems every day so you remain familiar with those concepts. But what about when you have 50, 100, 500 problems? It is no longer feasible to work through every single one. The SuperMemo 2 spatial repitition style of learning is one solution to this problem: strategically space out when you solve the problems so you only are doing a manageable amount every day. So thus, Repcode.io was born to bridge this gap between organization and learning.</p>

                    <p className="text-primary2 dark:text-primary">                    
                    This Guide page is meant to help new users get familiar with the Repcode.io enviornment and navigate through its various features with ease. The first part is dedicated to getting familiar with the enviornment, and the second part will teach you about the spatial repitition algorithm that we use, how it works and how to best make use of it. Whether you&apos;re setting up your first collection, tackling your initial problem, or diving deep into our specialized Study Mode, this guide is your roadmap to making the most of Repcode.io&apos;s dynamic resources. Get ready to enhance your coding skills, boost your problem-solving capabilities, and prepare effectively for your technical interviews with confidence!</p>
                </div>

                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-2 inline-block border-b-2 border-feintwhite dark:border-divide text-neutral dark:text-white">Sidebar</h2>
                    ...
                    <ul className="list-disc text-primary2 dark:text-primary mb-8 ml-5">
                      ...
                      <li>(4) - Settings. Clicking this will navugate you to the settings page, where you can customize different settings relating to the spatial repition algorithm</li>
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-2 inline-block border-b-2 border-feintwhite dark:border-divide text-neutral dark:text-white">Dashboard (Collections Page)</h2>
                    <p className="text-primary2 dark:text-primary mb-8">
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-2 inline-block border-b-2 border-feintwhite dark:border-divide text-neutral dark:text-white">Problems List</h2>
                    <p className="text-primary2 dark:text-primary mb-8">
                ...
                <div className="mb-8">
                    <h2 className="text-2xl font-bold mb-2 inline-block border-b-2 border-feintwhite dark:border-divide text-neutral dark:text-white">Problem Interface</h2>
                    <p className="text-primary2 dark:text-primary mb-8">
