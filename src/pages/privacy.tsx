        ...
        <div className="flex flex-col min-h-screen bg-base_100">
            ...
            <main className="flex-grow flex flex-col items-center justify-center px-4 py-8 text-primary">
                ...
                <div className="max-w-4xl text-center space-y-6">
                    ...
                    <p className="text-lg">Repcode.io (“Repcode” “we” or “us”) is committed to protecting your privacy. This Privacy Policy explains the methods and reasons we collect, use, disclose, transfer, and store your information. If you have any questions about the contents of this policy, don't hesitate to contact us.</p>
